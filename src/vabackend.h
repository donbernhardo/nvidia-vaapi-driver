...
typedef struct _NVDriver
{
    ...
    CUmodule                videoProcResizeModule;
    CUfunction              videoProcResizeU8Kernel;
    CUfunction              videoProcResizeU16Kernel;
    ...
    CUdeviceptr             videoProcResizeSrcBuffer;
    CUdeviceptr             videoProcResizeDstBuffer;
    size_t                  videoProcYBufferSize;
    size_t                  videoProcUVBufferSize;
    size_t                  videoProcArgbBufferSize;
    size_t                  videoProcResizeSrcBufferSize;
    size_t                  videoProcResizeDstBufferSize;
